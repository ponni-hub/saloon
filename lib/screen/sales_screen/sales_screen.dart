...
class _SalesScreenState extends State<SalesScreen> {
  final List<Product> popularSales = [
    Product(
      title: 'Shampoo',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty10.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Seerum',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty9.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Libom',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty8.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'foundation',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty7.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Libboms',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty6.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Lipstick',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty5.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'foundations',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty4.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Lotion',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty3.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Toner',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty2.jpg',
      weights: ['50g', '100g'],
    ),
  ];
  ...
  final List<Product> beautyProducts = [
    Product(
      title: 'Gel',
      price: 'BHD 150.00/-',
      imageUrl: 'assets/images/bty1.jpg',
      weights: ['50g', '100g'],
    ),
    Product(
      title: 'Face Cream',
